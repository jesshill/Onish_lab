...
#print(utils::getSrcDirectory(function(){})[1])
#print(utils::getSrcFilename(function(){}, full.names = TRUE))

#setwd(utils::getSrcDirectory(function(){})[1])


#setwd('C:\\Users\\hunte\\Desktop\\oligostan')
setwd('/mnt/c/Users/hunte/Desktop/oligostan')
#getwd()

args = commandArgs(trailingOnly=TRUE)
#print(args)
genes = readLines(args[1])
#genes = readLines("test.txt")



for(i in genes){
  FileNameFasta <- paste(i,".fa",sep="")
  
  #FASTA Sequences: path   [no '/' at the end of the path name]
  #WINDOWS IMPORTANT: Replace the separators in the path name \ by /
  #PathNameFasta <- 'C:\\Users\\hunte\\Desktop\\oligostan'
  PathNameFasta <- '/mnt/c/Users/hunte/Desktop/oligostan'
